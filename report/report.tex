...
The peak of the memory usage is located right after the data reading, before the balancing removes the majority of data through undersampling.\\
...
\begin{itemize}
    ...
    \item \textbf{PySpark Memory Usage}
          \begin{itemize}
              \item Average: DA INSERIRE
              \item Peak: DA INSERIRE
          \end{itemize}
\end{itemize}
...
\begin{center}
    \begin{tabular}{ |c|c|c|c|c|c|c|c|c|c|c| }
        ...
        \hline
        0    & 834 & 906 & 591 & 720 & 0.5571    & 0.6052 & 0.5802 & 0.5703   & 0.5366      & 0.5709 \\
        \hline
    \end{tabular}
...
\begin{center}
    \begin{tabular}{ |c|c|c|c|c|c|c|c|c|c|c| }
        ...
        Loss & TN   & TP  & FN  & FP  & Precision & Recall & F1     & Accuracy & Specificity & AUROC  \\
        \hline
        0    & 1019 & 832 & 665 & 535 & 0.6086    & 0.5557 & 0.5810 & 0.6066   & 0.6557      & 0.6057 \\
        \hline
    \end{tabular}
...
The execution of the experiments, starting with the hyperparameters search grid of the proposed implementation and again the problem seems to be too complex for a Logistic Regressiong model,
